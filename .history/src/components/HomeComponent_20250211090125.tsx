...
export default function HomeComponent() {
  return (
    ...
    >
      ...
      <div className="w-full flex justify-start items-end p-4 px-10 border-4 mb-10">
        <div className="flex space-x-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center space-x-2 text-orange-300 hover:text-gray-600 transition-colors"
          >
